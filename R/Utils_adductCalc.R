...
getAdductCalc <- function() {
  ...
  adductCalc <- list("M+3H" = c(1/3, (3 * 1.007276) / 3, "H3", "C0", 3),
...
getNeutralLossCalc <- function() {
  ...
  neutralLossCalc <- list("M-H2O+H" = c(1, -17.003838, "H1", "H2O"),
...
getAllNegModeAdducts <- function() {
  # return a vector with names of adducts
  return(c("M-3H", "M-2H", "M-H", "M+Na-2H", "M+Cl", "M+K-2H", "M+FA-H", "M+HAc-H", "M+Br", "M+TFA-H", "2M-H", "2M+FA-H",
           "2M+HAc-H","3M-H"))
}
